...
function buildSideReplay(points, persistence) {
  return {
    ...
    snapshots: points.map((point) => ({
      ...
      total_over_price: point.total_over_price,
      total_under_price: point.total_under_price,
      run_line_points: point.run_line_points,
      run_line_price: point.run_line_price,
